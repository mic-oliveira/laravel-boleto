...
/*            $this->getSignature()->setAccount(config('boleto.bradesco_account'));
            $this->getSignature()->setAgency(config('boleto.bradesco_agency'));*/
            ...
            dump($this->getSignature()->getBradSignature());
            dump(AuthService::makeHeaders($this->getSignature()));
        } catch (Exception $exception) {
            throw $exception;
        }
    }
